...
st.markdown(
    f"""
1️⃣ **降低應稅資產**  
以第 **{change_year}** 年變更為例，第一代應稅資產約降低 **{fmt_y(gift_with_policy)}**（以當年保單價值準備金為準）。  

2️⃣ **壓縮一代資產集中度**  
透過**變更要保人**，可靈活規劃資產歸屬，使資產更均衡地分佈於家族成員名下。  

3️⃣ **預留二代稅源**  
身故保險金可作為潛在**遺產稅/贈與稅的稅源預備金**，避免後代因繳稅壓力而被迫處分核心資產。  

4️⃣ **資產放大效果**  
同樣的現金，存款「1 元=1 元」；透過壽險，於約定事件可**放大為保額**（依商品與核保條件），提升家族風險承擔能力。  

5️⃣ **資產公平調控**  
法定繼承通常平均分配；但**保單可指定受益人與比例**，對資產差異較大的子女，得以**差額補強**，更貼近家族治理意圖。  

6️⃣ **定向傳承**  
可**精準指定受益對象與比例**，並可搭配信託/保全條款，實現教育金、創業金、長照金等**專款專用**。  

7️⃣ **遺產外即時現金**  
保險金通常可作為**遺產外之即時現金**（以保單條款與法規為準），受益人得迅速取得，緩解週轉與稅務繳納之需求。
"""
)
